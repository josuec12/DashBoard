...
const RegisteA = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if(!nom || !ape || !cedula || !emaila || !passw){
      Swal.fire({
        icon: 'warning',
          ...
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="text" className="inputF" id="nom" value={nom} onChange={(e) => setNom(e.target.value)} autoComplete="off" placeholder="Nombre" />
              </div>
            </div>
            <div className="col">
              <div className="inputForm">
                ...
                <input type="text" className="inputF" id="ape" value={ape} onChange={(e) => setApe(e.target.value)} autoComplete="off" placeholder="Apellido" />
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="number" className="inputF" id="cedula" value={cedula} onChange={(e) => setCedula(e.target.value)} autoComplete="off" placeholder="Cedula" />
              </div>
            </div>
            <div className="col">
              <div className="inputForm">
                <svg height="20" viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path></svg>
                <input type={showPasswordIconA ? "text" : "password"} className="inputF" id="passw" value={passw} onChange={(e) => setPassw(e.target.value)} placeholder="***********"></input>
                {showPasswordIconA ? (
          ...
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="email" className="inputF" id="emaila" value={emaila} onChange={(e) => setEmaila(e.target.value)} autoComplete="off" placeholder="Email" />
              </div>
            </div>
          </div>
