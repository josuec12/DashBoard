...
const RegisterU = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!nombre || !apellido || !nit || !pass || !email || !ventas || !financiero) {
      Swal.fire({
        icon: 'warning',
          ...
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="text" className="inputF" id="nombre"  value={nombre} onChange={(e) => setNombre(e.target.value)} autoComplete="off" placeholder="Nombre" />
              </div>
            </div>
            <div className="col">
              <div className="inputForm">
                ...
                <input type="text" className="inputF" id="apellido" value={apellido} onChange={(e) => setApellido(e.target.value)} autoComplete="off" placeholder="Apellido" />
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="number" className="inputF" id="nit" value={nit} onChange={(e) => setNit(e.target.value)} autoComplete="off" placeholder="Nit" />
              </div>
            </div>
            <div className="col">
              <div className="inputForm">
                <svg height="20" viewBox="-64 0 512 512" width="20" xmlns="http://www.w3.org/2000/svg"><path d="m336 512h-288c-26.453125 0-48-21.523438-48-48v-224c0-26.476562 21.546875-48 48-48h288c26.453125 0 48 21.523438 48 48v224c0 26.476562-21.546875 48-48 48zm-288-288c-8.8125 0-16 7.167969-16 16v224c0 8.832031 7.1875 16 16 16h288c8.8125 0 16-7.167969 16-16v-224c0-8.832031-7.1875-16-16-16zm0 0"></path><path d="m304 224c-8.832031 0-16-7.167969-16-16v-80c0-52.929688-43.070312-96-96-96s-96 43.070312-96 96v80c0 8.832031-7.167969 16-16 16s-16-7.167969-16-16v-80c0-70.59375 57.40625-128 128-128s128 57.40625 128 128v80c0 8.832031-7.167969 16-16 16zm0 0"></path></svg>
                <input type={showPasswordIconU ? "text" : "password"} className="inputF" id="pass" value={pass} onChange={(e) => setPass(e.target.value)} placeholder="***********"></input>
                {showPasswordIconU ? (
          ...
          <div className="row">
            <div className="col">
              <div className="inputForm">
                ...
                <input type="url" className="inputF" id="ventas" value={ventas} onChange={(e) => setVentas(e.target.value)} placeholder="https://www.example.com/Ventas"></input>
            ...
            <div className="col">
              <div className="inputForm">
                <svg xmlns="http://www.w3.org/2000/svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg>
                <input type="url" className="inputF" id="financiero" value={financiero} onChange={(e) => setFinanciero(e.target.value)} placeholder="https://www.example.com/Financiero"></input>
              </div>
            </div>
          </div>
          <div className="row">
            <div className="col">
              <div className="inputForm emailInp">
                ...
                <input type="email" className="inputF" id="email" value={email} onChange={(e) => setEmail(e.target.value)} autoComplete="off" placeholder="Email" />
              </div>
            </div>
          </div>
