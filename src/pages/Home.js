        ...
        <div className="cont">
          <div className="boletin">
            ...
            <div className="pdf-container">
              {besitzBol ? (
                <object data={`http://localhost:5000/${besitzBol}`} className="cyb">
                  ...
                  <button className="Documents-btn">
                    ...
                    <a className="textD" href={`http://localhost:5000/${besitzBol}`} download target='blank'>Ver PDF</a>
                  </button>
                  </div>
                </object>
              ) : (
                <p>El boletín no está disponible.</p>
              )}
            </div>
          </div>
